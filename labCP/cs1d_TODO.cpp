...
#include "cs1d.h" //definition of the master and the slave problem
#include "knapsack.h"
#include <cmath>
#include <iostream>
#include <fstream>
...
void Data::read(cconviene avere due onst char* filename)
{
...
{
	// setup initial LP (sigle item pattern)
...
{
	// solve - lp is a solver for LP (RELAXATION)
...
{
	KPSolver kp(pricerEnv); //slave problem -step2
	std::vector<double> z;
	double value;
